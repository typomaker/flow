...
func convert_GojaValue_List(rm *goja.Runtime, src goja.Value, dst *[]flow.Node) (err error) {
	switch src.ExportType() {
	case reflectLazyList:
...
func convert_GojaValue_Item(rm *goja.Runtime, src goja.Value, dst *flow.Node) (err error) {
	switch src.ExportType() {
	case reflectLazyNode:
...
func convert_GojaValue_Meta(rm *goja.Runtime, src goja.Value, dst *flow.Meta) (err error) {
	switch src.ExportType() {
	case reflectLazyObject:
...
func convert_GojaValue_Hook(rm *goja.Runtime, src goja.Value, dst *flow.Hook) (err error) {
	switch src.ExportType() {
	case reflectLazyObject:
...
func convert_GojaValue_Live(rm *goja.Runtime, src goja.Value, dst *flow.Live) (err error) {
	switch src.ExportType() {
	case reflectLazyLive:
...
func convert_GojaValue_When(rm *goja.Runtime, src goja.Value, dst *flow.When) (err error) {
	if src == nil {
		return nil
	}
...
//nolint:funlen,gocognit // отрефакторить
func convert_GojaValue_Then(rm *goja.Runtime, src goja.Value, dst *flow.Then) (err error) {
	if src == nil {
		return nil
	}
...
func convert_Live_Any(rm *goja.Runtime, src flow.Live, dst *any) (err error) {
...
func convert_Live_GojaValue(rm *goja.Runtime, src flow.Live, dst *goja.Value) (err error) {
